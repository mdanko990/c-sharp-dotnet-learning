...
namespace MembershipManagement.Controllers
{
    ...
    public class RegistrationsController : ControllerBase
    {
        ...
        // GET: api/Registrations/users/5
        [HttpGet("users/{eventId}")]
        public async Task<ActionResult<Registration>> GetRegistration(long eventId)
        {
            var registration = await _context.Registrations.FindAsync(eventId);
